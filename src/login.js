  ...
  render() {
      return (
          ...
          <View style={styles.container}>
              <Image resizeMode="contain" style={styles.logo} source={require('../images/sunkpo.png')} />
              
              <Text style={styles.text1}>DietKonnect</Text>
              ...
              <Content>
                  ...
                  <Item stackedLabel last>
                      ...
                      <Button full regular
                         style={{ marginTop: 30, marginLeft: 5, marginRight: 5,backgroundColor:'green' }} onPress = { signIn }>
                        ...
                        <Text style={{textAlign:"center",paddingTop:20}}>(c)SunKPO Systems LLP, 2019
</Text>
